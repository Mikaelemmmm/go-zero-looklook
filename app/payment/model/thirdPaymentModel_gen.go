...
var (
	...
	cacheSysOaThirdPaymentIdPrefix = "cache:sysOa:thirdPayment:id:"
	cacheSysOaThirdPaymentSnPrefix = "cache:sysOa:thirdPayment:sn:"
)
...
func (m *defaultThirdPaymentModel) Insert(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	sysOaThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheSysOaThirdPaymentIdPrefix, data.Id)
	sysOaThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheSysOaThirdPaymentSnPrefix, data.Sn)
	...
	}, sysOaThirdPaymentIdKey, sysOaThirdPaymentSnKey)
}

func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	sysOaThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheSysOaThirdPaymentIdPrefix, id)
	var resp ThirdPayment
	err := m.QueryRowCtx(ctx, &resp, sysOaThirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	sysOaThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheSysOaThirdPaymentSnPrefix, sn)
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, sysOaThirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultThirdPaymentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheSysOaThirdPaymentIdPrefix, primary)
}
