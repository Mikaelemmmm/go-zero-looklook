...
var (
	...
	cacheSysOaUserIdPrefix     = "cache:sysOa:user:id:"
	cacheSysOaUserMobilePrefix = "cache:sysOa:user:mobile:"
)
...
func (m *defaultUserModel) Insert(ctx context.Context, session sqlx.Session, data *User) (sql.Result, error) {
	...
	sysOaUserIdKey := fmt.Sprintf("%s%v", cacheSysOaUserIdPrefix, data.Id)
	sysOaUserMobileKey := fmt.Sprintf("%s%v", cacheSysOaUserMobilePrefix, data.Mobile)
	...
	}, sysOaUserIdKey, sysOaUserMobileKey)
}

func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	sysOaUserIdKey := fmt.Sprintf("%s%v", cacheSysOaUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, sysOaUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	sysOaUserMobileKey := fmt.Sprintf("%s%v", cacheSysOaUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, sysOaUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheSysOaUserIdPrefix, primary)
}
