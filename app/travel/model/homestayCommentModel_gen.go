...
var (
	...
	cacheSysOaHomestayCommentIdPrefix = "cache:sysOa:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	sysOaHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayCommentIdPrefix, data.Id)
	...
	}, sysOaHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	sysOaHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, sysOaHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheSysOaHomestayCommentIdPrefix, primary)
}
