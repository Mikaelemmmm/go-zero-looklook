...
var (
	...
	cacheSysOaHomestayBusinessIdPrefix     = "cache:sysOa:homestayBusiness:id:"
	cacheSysOaHomestayBusinessUserIdPrefix = "cache:sysOa:homestayBusiness:userId:"
)
...
func (m *defaultHomestayBusinessModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayBusiness) (sql.Result, error) {
	...
	sysOaHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayBusinessIdPrefix, data.Id)
	sysOaHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayBusinessUserIdPrefix, data.UserId)
	...
	}, sysOaHomestayBusinessIdKey, sysOaHomestayBusinessUserIdKey)
}

func (m *defaultHomestayBusinessModel) FindOne(ctx context.Context, id int64) (*HomestayBusiness, error) {
	sysOaHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayBusinessIdPrefix, id)
	var resp HomestayBusiness
	err := m.QueryRowCtx(ctx, &resp, sysOaHomestayBusinessIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayBusinessModel) FindOneByUserId(ctx context.Context, userId int64) (*HomestayBusiness, error) {
	sysOaHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayBusinessUserIdPrefix, userId)
	var resp HomestayBusiness
	err := m.QueryRowIndexCtx(ctx, &resp, sysOaHomestayBusinessUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayBusinessModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheSysOaHomestayBusinessIdPrefix, primary)
}
