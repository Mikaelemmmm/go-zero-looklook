...
var (
	...
	cacheSysOaHomestayActivityIdPrefix = "cache:sysOa:homestayActivity:id:"
)
...
func (m *defaultHomestayActivityModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayActivity) (sql.Result, error) {
	...
	sysOaHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayActivityIdPrefix, data.Id)
	...
	}, sysOaHomestayActivityIdKey)
}

func (m *defaultHomestayActivityModel) FindOne(ctx context.Context, id int64) (*HomestayActivity, error) {
	sysOaHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheSysOaHomestayActivityIdPrefix, id)
	var resp HomestayActivity
	err := m.QueryRowCtx(ctx, &resp, sysOaHomestayActivityIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayActivityModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheSysOaHomestayActivityIdPrefix, primary)
}
