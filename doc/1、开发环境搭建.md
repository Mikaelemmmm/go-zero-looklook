...
```shell
$ curl  -X POST "http://127.0.0.1:8888/usercenter/v1/user/login" -H "Content-Type: application/json" -d "{\"mobile\":\"18888888888\",\"password\":\"123456\",}" 
```
...
![image-20220117180955110](./images/1/image-20220117180955110.png)
