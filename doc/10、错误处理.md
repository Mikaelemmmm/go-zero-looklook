...
![image-20220124110141968](./images/8/image-20220124110141968.png)
...
![image-20220124110841829](./images/8/image-20220124110841829.png)
...
【注⚠️】我们在rpc的启动文件main方法中，加了grpc的全局拦截器，这个很重要 ，如果不加这个没办法实现

![image-20220124111316294](./images/8/image-20220124111316294.png)
...
![image-20220124112235547](./images/8/image-20220124112235547.png)
...
​			针对这种情况，如下图这样写即可（当然你可以将xerr.NewErrMsg("用户注册失败") 放到代码上方使用一个变量，这里放变量也可以）

![image-20220124112807534](./images/8/image-20220124112807534.png)
...
![image-20220124113041628](./images/8/image-20220124113041628.png)
...
![image-20220124114836961](./images/8/image-20220124114836961.png)

我们主要来看HttpResult ， 业务返回的错误处理的

![image-20220124113655782](./images/8/image-20220124113655782.png)
