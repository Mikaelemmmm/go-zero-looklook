...
CREATE TABLE `homestay` (
  ...
  `food_info` varchar(2048) COLLATE utf8mb4_general_ci NOT NULL COMMENT '餐食标准',
...
CREATE TABLE `homestay_business` (
  ...
  `delete_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `del_state` tinyint NOT NULL DEFAULT '0',
  `title` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '店铺名称',
  ...
  `boss_info` varchar(128) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '房东介绍',
  ...
  `tags` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '每个店家一个标签，自己编辑',
