...
CREATE TABLE `homestay_order` (
  ...
  `food_info` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '餐食标准',
  ...
  `trade_code` char(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '确认码',
  `remark` varchar(64) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '用户下单备注',
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='每一间民宿';
